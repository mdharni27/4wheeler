...
<body>
    ...
    <header class="header" id="header">
       ...
       <nav class="nav container">
           ...
           <ul class="nav__list">
               <li class="nav__item"> 
                   <a href="index.php" class=" main__hover nav__link active-link heading__16 underline__animations">
                       Home
                   </a>
               </li>
               <li class="nav__item"> 
     ...
     <div class="wrap ">
         ...
         <div class="logo__title resale__order">
             <div class="logo__wrap resale__wrap">
               <!--<img src="public/icon/resale wrap1.svg" alt="valuation img">-->
               <img src="resale1i.png" alt="valuation img">
			 </div>
         </div>
                ...
                <div class="userinput__container resale__input-container">
                    <form action="/" method="POST" class="form">
                        ...
                        <div class="input__1" id="lnput-brand">
                            <label class="heading__18 lables" for="Email">Brand*</label>
                            <select id="inputbrand"  class="resale__color" name="company" required="1"
                        ...
                        <div class="input__1" id="lnput-model">
                            <label class="heading__18 lables" for="Your Password">Model*</label>
                            <select id="inputmodel"  class="resale__color" name="company" required="1"
                            onchange="load_car_models(this.id,'car_models')">
                        {% for company in companies %}
                        <option value="{{ Hyundai }}">Select Model</option>
                        <option value="{{ Tata }}">Harrier</option>
                        <option value="{{ Tata }}">Punch Adventure</option>
                        <option value="{{ Tata}}">Nexon EV</option>
                        <option value="{{ Tata}}">Nexon Hybrid</option>
                        ...
                        <div class="input__1" id="lnput-variant">
                            <label class="heading__18 lables" for="Your Password">Variant*</label>
                            <select id="inputvariant"  class="resale__color" name="company" required="1"
                                    onchange="load_car_models(this.id,'car_models')">
                                {% for company in companies %}
                                <option value="{{ Hyundai }}">Select Variant</option>
                                <option value="{{ Hyundai }}">XM</option>
                                <option value="{{ Hyundai }}">XMA AT</option>
                                <option value="{{ Hyundai }}">Adventure</option>
                                <option value="{{ Hyundai }}">XE</option>
                                <option value="{{ Hyundai }}">XT Limited Edition</option>
                                {% endfor %}
                            </select>
                        </div>
        
                        <! Button>
                        <div class="submit__container submit__resale">
                            <a href="Resale2.php" role="button" class="login__button button__primary"> Continue
                            </a>
                        </div>
                    </form>
                </div>
